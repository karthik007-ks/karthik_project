...
public class TC_9_create_Contact_Test extends BaseClass
{
	...
	{	
		...
		String option1 = Eutil.getExcelData("Sheet3", 2, 2);
		...
		create.ClickOnUserRadioButton();
		Thread.sleep(2000);
		create.UserDropdown(option1);
